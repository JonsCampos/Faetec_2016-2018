...
      	<meta name="viewport" content="width=device-width, initial-scale=1">
			<title>Entrada de Calçados</title>
...
      	<link href="../css/style.css" rel="stylesheet" type="text/css" >
	...
	<h3 class="page-header">Entrada de calçados na loja</h3>
	
	<div id="msg_alert"><?php include "mensagens.php"; ?></div>
  	  
	<!-- area de campos do form -->
	
	<form class="form-group" id="form_itens_rec" action="insere_ent.php" method="POST" autocomplete="off">
		<!-- 1ª LINHA -->	
		<div class="row">
		
			<div class="form-group col-sm-1 col-xs-12">
				<label for="cod_recibo">Recibo</label>
				  <input type="text" class="form-control" name="cod_recibo" id="cod_recibo">
		...
		<h4>Itens do recibo <small>  [Digite conforme a nota de compra]</small></h4>
			...
			<div class="row">
				...
				<div class="form-group col-sm-1 col-xs-12">
					<label for="preco_entrada">Preço</label>
					<input type="text" class="form-control" name="preco_entrada" id="preco_entrada">
				</div>
				
				<div class="form-group col-sm-2 col-xs-12">
					<label for="qtde_entrada">Quantidade</label>
					<input type="text" class="form-control" name="qtde_entrada" id="qtde_entrada" value="0">
				</div>
		...
		<div id="actions" class="row">
			<div class="col-xs-12">
				<a href="lista_ent.php" class="btn btn-primary">Encerrar</a>
