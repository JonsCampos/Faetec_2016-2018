    ...
    <div id="main" class="container-fluid">
        <div id="top" class="row">
            <div class="col-sm-8 col-xs-12">
                <?php
						...
						include "../base/conexao.php";
							...
							$sql  = "select r.cod_recibo, e.cod_ent, p.nome_cal, e.qtde_entrada, ";
							$sql .= "e.preco_entrada, r.dt_emissao, f.nome_forn, p.qtde_estoque, p.numero, r.nr_rec_forn ";
							$sql .= "from fornecedor f, recibo r, entrada e, calcado p ";
							$sql .= "where f.cod_forn = r.cod_forn and p.cod_cal = e.cod_cal ";
							$sql .= "and f.cod_forn = e.cod_forn and r.cod_recibo = e.cod_recibo ";
							$sql .= "and r.cod_recibo = '".$_SESSION['scr']."' order by e.cod_ent";

						$data = mysql_query($sql) or die(mysql_error());
						$dadorec = mysql_fetch_array($data);
						echo "<br><h2>Itens de entrada - Recibo cod: <strong>".$dadorec['cod_recibo']."</strong> / nº: <strong>".$dadorec['nr_rec_forn']."</strong></h2>";
					?>
            </div>
            ...
            <div class="col-sm-4 col-xs-12 pull-right">
                ...
                <br>
                <a href="entrada.php" class="btn btn-primary pull-right h2">Nova Entrada de Itens</a>
            </div>
        </div>
        ...
        <div id="list" class="row">
            <div class="table-responsive col-xs-12">
                ...
                <?php
							...
							echo "<td><center><strong>Quantidade da entrada</strong></center></td>";
							echo "<td><center><strong>Valor da entrada</strong></center></td>";
							...
							while($info = mysql_fetch_array($data_all)){ 
								...
								echo "<td><center>".$info['cod_ent']."</center></td>";
								echo "<td><center>".$info['nome_cal']."</center></td>";
                                echo "<td><center>".$info['numero']."</center></td>";
								echo "<td><center>".$info['qtde_entrada']."</center></td>";
                                echo "<td><center> R$ ".$info['preco_entrada']."</center></td>";
        ...
        <div class="row col-xs-12">
            ...
            <a href="../relatorio/rrecnum_ent/rel_recnum.php" class="btn btn-primary"><span class="glyphicon glyphicon-print"></span> Imprimir</a>
