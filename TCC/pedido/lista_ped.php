			...
			<div id="top" class="row">
				...
				<div class="col-sm-6 col-xs-12">
					<div class="input-group h2">
						<input name="data-[search]" onKeydown="Javascript: if (event.keyCode==13) PesquisaConteudoPed();" class="form-control" id="search_ped" type="text" placeholder="Pesquisar Pedidos">
						<span class="input-group-btn">
							<button class="btn btn-primary" onclick="PesquisaConteudoPed()" type="submit"> 
				...
				<div class="col-sm-3 col-xs-12">
					<!-- Chama o Formulário para adicionar Pedidos -->
					<a href="fadd_ped.php" class="btn btn-primary pull-right h2">Novo Pedido</a> 
				</div>
			</div>
			...
			<div id="bloco-list-pag">	
				<div id="list" class="row">
					<div class="table-responsive col-xs-12">
						...
						<?php
							...
							$data_all = mysql_query("select * from pedido r, fornecedor f where f.cod_forn = r.cod_forn order by cod_ped asc limit $inicio, $quantidade;") or die(mysql_error());
				...
				<div id="bottom" class="row">
					<div class="col-xs-12">
						...
						<ul class="pagination">
						<?php 
							$sqlTotal 		= "select cod_ped from pedido;";
