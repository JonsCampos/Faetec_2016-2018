...
<html lang="pt-br">
	...
	<div id="main" class="container-fluid">
		...
		<div id="top" class="row">
			<div class="col-xs-12">
				<br>
				<h2><center>Relatório de Pedidos por Período</center></h2>
			</div>
		</div>
				...
				<div class="table-responsive col-xs-12">
					...
					<?php
						...
						while($info_rec = mysql_fetch_array($data_rec)){ 
							...
							$sql .= "and r.cod_ped = '".$info_rec['cod_ped']."' and r.dt_ped between '".$dt_ini."' and '".$dt_fim."' order by e.cod_iped;";
							
							$data_all = mysql_query($sql) or die(mysql_error());
							
							if(mysql_num_rows($data_all) > 0){
								
								echo "<tr class='bg-default'><td colspan='6'><strong>Pedido nº: ".$info_rec['cod_ped']."</strong></td></tr>";
