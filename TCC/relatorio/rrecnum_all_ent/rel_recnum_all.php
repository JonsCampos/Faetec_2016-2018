<?php 
						...
						$html .= "
						<h2><div class='titulorel'>Relatório de Entradas por período</div></h2>
						";
						...
						<tr>
							...
							<td width='17%'><center><strong>QUANTIDADE DA ENTRADA</strong></center></td>
							<td width='15%'><center><strong>VALOR DA ENTRADA</strong></center></td>
						...
						while($info_rec = mysql_fetch_array($data_rec)){
							...
							$sql .= "between '".$dt_ini."' and '".$dt_fim."' order by e.cod_ent;";
