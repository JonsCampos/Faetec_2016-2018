...
<html lang="pt-br">
	<head>
        ...
        <link rel="icon" href="../../logo/logo_icon.ico" type="image/x-icon" />
			<title>Relatório de Entradas por período</title>
	...
	<div id="main" class="container-fluid">
		...
		<div id="top" class="row">
			<div class="col-xs-12">
				<br>
				<h2><center>Relatório de Entradas por Período</center></h2>
			</div>
		</div>
				...
				<div class="table-responsive col-xs-12">
					...
					<?php
						...
						while($info_rec = mysql_fetch_array($data_rec)){ 
							...
							$sql .= "and r.cod_recibo = '".$info_rec['cod_recibo']."' and r.dt_emissao between '".$dt_ini."' and '".$dt_fim."' order by e.cod_ent;";
							...
							if(mysql_num_rows($data_all) > 0){
								...
								while($info = mysql_fetch_array($data_all)){
									...
									echo "<td><center>R$ ".number_format($info['preco_entrada'], 2,',','.')."</center></td>";
